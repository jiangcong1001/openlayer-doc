...
export default defineConfig({
  title: "Openlayer中文开发指南",
  description: "贴心Openlayer学习资料",
  head: [
    // 站点图标
    ...
    [
      "meta",
      {
        name: "keywords",
        content:
          "本页面根据在使用OpenLayers过程中记录的各种资料，包括API手册、入门教程和实用技巧，旨在帮助开发者更好地理解和使用OpenLayers进行GIS开发。OpenLayers是一个功能强大的Web地图渲染库，广泛应用于地理信息系统的开发中",
      },
    ],
    // 百度统计
    [
